...
final class CategoryController extends AbstractController
{
    ...
    public function create(Request $request, EntityManagerInterface $em, ValidatorInterface $validator): Response
    {
        ...
        $this->appendCategoryValidationErrors($errors, $validator->validate($categorie));
    ...
    private function appendCategoryValidationErrors(array &$errors, iterable $violations): void
    {
