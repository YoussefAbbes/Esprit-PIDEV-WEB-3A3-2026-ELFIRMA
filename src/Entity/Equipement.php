...
class Equipement
{
    ...
    public function setTypeEq(string $type_eq): self
    {
    ...
    #[ORM\Column(enumType: EquipementEtat::class, length: 20, nullable: true)]
    private ?EquipementEtat $etat = null;
    ...
    public function setCoutAchat(float $cout_achat): self
    {
